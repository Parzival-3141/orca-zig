...
pub const vec2_equal = oc_vec2_equal;
extern fn oc_vec2_equal(
    /// The first vector
    v0: vec2,
    /// The second vector
    v1: vec2,
...
pub const vec2_mul = oc_vec2_mul;
extern fn oc_vec2_mul(
...
/// Add two 2D vectors
pub const vec2_add = oc_vec2_add;
extern fn oc_vec2_add(
    /// The first vector.
    v0: vec2,
    /// The second vector.
    v1: vec2,
...
pub const mat2x3_mul = oc_mat2x3_mul;
...
pub const mat2x3_mul_m = oc_mat2x3_mul_m;
...
pub const mat2x3_inv = oc_mat2x3_inv;
...
pub const mat2x3_rotate = oc_mat2x3_rotate;
extern fn oc_mat2x3_rotate(
    /// The rotation angle, in radians.
    radians: f32,
) callconv(.C) mat2x3;
/// Return a 2x3 matrix representing a translation.
pub const mat2x3_translate = oc_mat2x3_translate;
...
pub const abort_ext = oc_abort_ext;
...
pub const assert_fail = oc_assert_fail;
...
pub const log_set_level = oc_log_set_level;
...
pub const oc_log_error = @compileError("TODO: translate macro");
/// Log a warning to the console.
pub const oc_log_warning = @compileError("TODO: translate macro");
/// Log a informative message to the console.
pub const oc_log_info = @compileError("TODO: translate macro");
/// Abort the application with an optional error message.
pub const OC_ABORT = @compileError("TODO: translate macro");
/// Test a given condition, and abort the application if it is false.
pub const OC_ASSERT = @compileError("TODO: translate macro");
/// Similar to `OC_ASSERT`, but only run in Debug mode.
pub const OC_DEBUG_ASSERT = @compileError("TODO: translate macro");
...
pub const list_insert_before = oc_list_insert_before;
...
pub const list_remove = oc_list_remove;
...
pub const list_push_back = oc_list_push_back;
...
pub const list_pop_front = oc_list_pop_front;
...
pub const arena_push_aligned = oc_arena_push_aligned;
...
pub const arena_clear = oc_arena_clear;
...
pub const arena_scope_begin = oc_arena_scope_begin;
...
pub const arena_scope_end = oc_arena_scope_end;
...
pub const scratch_begin = oc_scratch_begin;
...
pub const scratch_begin_next = oc_scratch_begin_next;
...
pub const str8_from_buffer = oc_str8_from_buffer;
...
pub const str8_slice = oc_str8_slice;
...
pub const str8_push_buffer = oc_str8_push_buffer;
...
pub const str8_push_cstring = oc_str8_push_cstring;
...
pub const str8_push_copy = oc_str8_push_copy;
...
pub const str8_push_slice = oc_str8_push_slice;
...
pub const str8_pushfv = oc_str8_pushfv;
...
pub const str8_pushf = oc_str8_pushf;
...
pub const str8_cmp = oc_str8_cmp;
...
pub const str8_to_cstring = oc_str8_to_cstring;
...
pub const str8_list_push = oc_str8_list_push;
...
pub const str8_list_pushf = oc_str8_list_pushf;
...
pub const str8_list_collate = oc_str8_list_collate;
...
pub const str8_list_join = oc_str8_list_join;
...
pub const str8_split = oc_str8_split;
...
pub const str16_from_buffer = oc_str16_from_buffer;
...
pub const str16_slice = oc_str16_slice;
...
pub const str16_push_buffer = oc_str16_push_buffer;
...
pub const str16_push_copy = oc_str16_push_copy;
...
pub const str16_push_slice = oc_str16_push_slice;
...
pub const str16_list_push = oc_str16_list_push;
...
/// Build a string by joining the elements of a string list.
pub const str16_list_join = oc_str16_list_join;
...
///
/// No string copies are made. The elements of the resulting string list refer to subsequences of the input string.
pub const str16_split = oc_str16_split;
...
pub const str32_from_buffer = oc_str32_from_buffer;
...
pub const str32_slice = oc_str32_slice;
...
pub const str32_push_buffer = oc_str32_push_buffer;
...
pub const str32_push_copy = oc_str32_push_copy;
...
pub const str32_push_slice = oc_str32_push_slice;
...
pub const str32_list_push = oc_str32_list_push;
...
/// Build a string by joining the elements of a string list.
pub const str32_list_join = oc_str32_list_join;
...
///
/// No string copies are made. The elements of the resulting string list refer to subsequences of the input string.
pub const str32_split = oc_str32_split;
...
pub const utf8_size_from_leading_char = oc_utf8_size_from_leading_char;
extern fn oc_utf8_size_from_leading_char(
    /// The first byte of utf8 sequence.
    leadingChar: u8,
) callconv(.C) u32;
/// Get the size of the utf8 encoding of a codepoint.
pub const utf8_codepoint_size = oc_utf8_codepoint_size;
extern fn oc_utf8_codepoint_size(
    /// A unicode codepoint.
    codePoint: utf32,
) callconv(.C) u32;
pub const utf8_codepoint_count_for_string = oc_utf8_codepoint_count_for_string;
extern fn oc_utf8_codepoint_count_for_string(
    /// A utf8 encoded string.
    string: str8,
) callconv(.C) u64;
/// Get the length of the utf8 encoding of a sequence of unicode codepoints.
pub const utf8_byte_count_for_codepoints = oc_utf8_byte_count_for_codepoints;
...
pub const utf8_next_offset = oc_utf8_next_offset;
...
pub const utf8_prev_offset = oc_utf8_prev_offset;
...
pub const utf8_encode = oc_utf8_encode;
...
pub const utf8_to_codepoints = oc_utf8_to_codepoints;
...
pub const utf8_from_codepoints = oc_utf8_from_codepoints;
...
pub const utf8_push_to_codepoints = oc_utf8_push_to_codepoints;
...
pub const utf8_push_from_codepoints = oc_utf8_push_from_codepoints;
...
pub const window_set_title = oc_window_set_title;
...
pub const file_open_at = oc_file_open_at;
...
/// Close a file.
pub const file_close = oc_file_close;
extern fn oc_file_close(
    /// The file handle to close.
    file: file,
) callconv(.C) void;
/// Get the current position in a file.
pub const file_pos = oc_file_pos;
extern fn oc_file_pos(
    /// A handle to the file.
    file: file,
) callconv(.C) i64;
/// Set the current position in a file.
pub const file_seek = oc_file_seek;
...
/// Write data to a file.
pub const file_write = oc_file_write;
...
/// Read from a file.
pub const file_read = oc_file_read;
...
pub const file_last_error = oc_file_last_error;
...
pub const file_get_status = oc_file_get_status;
extern fn oc_file_get_status(
    file: file,
) callconv(.C) file_status;
pub const file_size = oc_file_size;
extern fn oc_file_size(
    file: file,
) callconv(.C) u64;
pub const file_open_with_request = oc_file_open_with_request;
...
pub const file_open_with_dialog = oc_file_open_with_dialog;
...
pub const path_join = oc_path_join;
...
pub const path_append = oc_path_append;
...
pub const path_is_absolute = oc_path_is_absolute;
...
//------------------------------------------------------------------------------------------
// [Graphics] 2D/3D rendering APIs.
//------------------------------------------------------------------------------------------

//------------------------------------------------------------------------------------------
// [Canvas API] A 2D Vector Graphics API.
//------------------------------------------------------------------------------------------
...
pub const surface_nil = oc_surface_nil;
extern fn oc_surface_nil() callconv(.C) surface;
/// Check if a surface handle is `nil`.
pub const surface_is_nil = oc_surface_is_nil;
extern fn oc_surface_is_nil(
    surface: surface,
) callconv(.C) bool;
/// Destroy a graphics surface.
pub const surface_destroy = oc_surface_destroy;
extern fn oc_surface_destroy(
    surface: surface,
) callconv(.C) void;
...
pub const surface_get_size = oc_surface_get_size;
extern fn oc_surface_get_size(
    surface: surface,
) callconv(.C) vec2;
/// Get the scaling factor of a surface.
pub const surface_contents_scaling = oc_surface_contents_scaling;
extern fn oc_surface_contents_scaling(
    surface: surface,
) callconv(.C) vec2;
/// Bring a surface to the foreground, rendering it on top of other surfaces.
pub const surface_bring_to_front = oc_surface_bring_to_front;
extern fn oc_surface_bring_to_front(
    surface: surface,
) callconv(.C) void;
/// Send a surface to the background, rendering it below other surfaces.
pub const surface_send_to_back = oc_surface_send_to_back;
extern fn oc_surface_send_to_back(
    surface: surface,
) callconv(.C) void;
/// Checks if a surface is hidden.
pub const surface_get_hidden = oc_surface_get_hidden;
extern fn oc_surface_get_hidden(
    surface: surface,
) callconv(.C) bool;
/// Set the hidden status of a surface.
pub const surface_set_hidden = oc_surface_set_hidden;
extern fn oc_surface_set_hidden(
    surface: surface,
    hidden: bool,
) callconv(.C) void;
/// An opaque handle representing a rendering engine for the canvas API.
pub const canvas_renderer = extern struct {
    h: u64,
};
...
pub const canvas_context = extern struct {
    h: u64,
};
...
pub const color_rgba = oc_color_rgba;
...
pub const color_srgba = oc_color_srgba;
...
pub const color_convert = oc_color_convert;
...
pub const canvas_renderer_nil = oc_canvas_renderer_nil;
extern fn oc_canvas_renderer_nil() callconv(.C) canvas_renderer;
/// Checks if a canvas renderer handle is `nil`.
pub const canvas_renderer_is_nil = oc_canvas_renderer_is_nil;
extern fn oc_canvas_renderer_is_nil(
    renderer: canvas_renderer,
) callconv(.C) bool;
/// Create a canvas renderer.
pub const canvas_renderer_create = oc_canvas_renderer_create;
extern fn oc_canvas_renderer_create() callconv(.C) canvas_renderer;
/// Destroy a canvas renderer.
pub const canvas_renderer_destroy = oc_canvas_renderer_destroy;
extern fn oc_canvas_renderer_destroy(
    renderer: canvas_renderer,
) callconv(.C) void;
/// Render canvas commands onto a surface.
pub const canvas_render = oc_canvas_render;
...
pub const canvas_present = oc_canvas_present;
...
pub const canvas_surface_create = oc_canvas_surface_create;
extern fn oc_canvas_surface_create(
    /// A canvas renderer.
    renderer: canvas_renderer,
) callconv(.C) surface;
/// Returns a `nil` canvas context handle.
pub const canvas_context_nil = oc_canvas_context_nil;
extern fn oc_canvas_context_nil() callconv(.C) canvas_context;
/// Checks if a canvas context handle is `nil`.
pub const canvas_context_is_nil = oc_canvas_context_is_nil;
extern fn oc_canvas_context_is_nil(
    context: canvas_context,
) callconv(.C) bool;
/// Create a canvas context.
pub const canvas_context_create = oc_canvas_context_create;
extern fn oc_canvas_context_create() callconv(.C) canvas_context;
/// Destroy a canvas context
pub const canvas_context_destroy = oc_canvas_context_destroy;
extern fn oc_canvas_context_destroy(
    context: canvas_context,
) callconv(.C) void;
...
pub const canvas_context_select = oc_canvas_context_select;
extern fn oc_canvas_context_select(
    context: canvas_context,
) callconv(.C) canvas_context;
/// Set the multisample anti-aliasing sample count for the commands of a context.
pub const canvas_context_set_msaa_sample_count = oc_canvas_context_set_msaa_sample_count;
...
extern fn oc_font_create_from_memory(
    ...
    ranges: [*c]unicode_range,
) callconv(.C) font;
/// Create a font from a TrueType font file.
pub const font_create_from_file = oc_font_create_from_file;
...
pub const font_create_from_path = oc_font_create_from_path;
...
/// Destroy a font.
pub const font_destroy = oc_font_destroy;
extern fn oc_font_destroy(
    font: font,
) callconv(.C) void;
/// Get the glyph indices of a run of unicode code points in a given font.
pub const font_get_glyph_indices = oc_font_get_glyph_indices;
...
pub const font_push_glyph_indices = oc_font_push_glyph_indices;
...
pub const font_get_glyph_index = oc_font_get_glyph_index;
...
pub const font_get_metrics = oc_font_get_metrics;
...
pub const font_get_metrics_unscaled = oc_font_get_metrics_unscaled;
extern fn oc_font_get_metrics_unscaled(
    font: font,
) callconv(.C) font_metrics;
/// Get a scale factor to apply to unscaled font metrics to obtain a given 'm' size.
pub const font_get_scale_for_em_pixels = oc_font_get_scale_for_em_pixels;
...
pub const font_text_metrics_utf32 = oc_font_text_metrics_utf32;
...
pub const font_text_metrics = oc_font_text_metrics;
...
pub const image_create_from_rgba8 = oc_image_create_from_rgba8;
...
pub const image_create_from_memory = oc_image_create_from_memory;
...
pub const image_create_from_file = oc_image_create_from_file;
...
pub const image_create_from_path = oc_image_create_from_path;
...
/// Destroy an image.
pub const image_destroy = oc_image_destroy;
extern fn oc_image_destroy(
    image: image,
) callconv(.C) void;
/// Upload pixels to an image.
pub const image_upload_region_rgba8 = oc_image_upload_region_rgba8;
...
pub const image_size = oc_image_size;
...
pub const rect_atlas_create = oc_rect_atlas_create;
...
pub const rect_atlas_alloc = oc_rect_atlas_alloc;
...
pub const rect_atlas_recycle = oc_rect_atlas_recycle;
...
pub const image_atlas_alloc_from_rgba8 = oc_image_atlas_alloc_from_rgba8;
...
pub const image_atlas_alloc_from_memory = oc_image_atlas_alloc_from_memory;
...
/// Allocate an image region from an atlas and upload an image to it.
pub const image_atlas_alloc_from_file = oc_image_atlas_alloc_from_file;
...
/// Allocate an image region from an atlas and upload an image to it.
pub const image_atlas_alloc_from_path = oc_image_atlas_alloc_from_path;
...
pub const image_atlas_recycle = oc_image_atlas_recycle;
...
pub const matrix_push = oc_matrix_push;
...
pub const matrix_multiply_push = oc_matrix_multiply_push;
extern fn oc_matrix_multiply_push(
    matrix: mat2x3,
) callconv(.C) void;
/// Pop a matrix from the transform stack.
pub const matrix_pop = oc_matrix_pop;
extern fn oc_matrix_pop() callconv(.C) void;
/// Get the top matrix of the transform stack.
pub const matrix_top = oc_matrix_top;
extern fn oc_matrix_top() callconv(.C) mat2x3;
/// Push a clip rectangle to the clip stack.
pub const clip_push = oc_clip_push;
...
pub const clip_pop = oc_clip_pop;
extern fn oc_clip_pop() callconv(.C) void;
/// Get the clip rectangle from the top of the clip stack.
pub const clip_top = oc_clip_top;
extern fn oc_clip_top() callconv(.C) rect;
/// Set the current color.
pub const set_color = oc_set_color;
extern fn oc_set_color(
    color: color,
) callconv(.C) void;
/// Set the current color using linear RGBA values.
pub const set_color_rgba = oc_set_color_rgba;
...
pub const set_color_srgba = oc_set_color_srgba;
...
pub const set_gradient = oc_set_gradient;
...
pub const set_width = oc_set_width;
...
pub const cubic_to = oc_cubic_to;
...
pub const rectangle_fill = oc_rectangle_fill;
...
pub const rectangle_stroke = oc_rectangle_stroke;
...
pub const rounded_rectangle_fill = oc_rounded_rectangle_fill;
...
pub const rounded_rectangle_stroke = oc_rounded_rectangle_stroke;
...
pub const ellipse_fill = oc_ellipse_fill;
...
pub const ellipse_stroke = oc_ellipse_stroke;
...
pub const circle_fill = oc_circle_fill;
...
pub const circle_stroke = oc_circle_stroke;
...
/// Draw a text line.
pub const text_fill = oc_text_fill;
...
/// Draw an image.
pub const image_draw = oc_image_draw;
extern fn oc_image_draw(
    image: image,
    rect: rect,
) callconv(.C) void;
/// Draw a sub-region of an image.
pub const image_draw_region = oc_image_draw_region;
...
pub const gles_surface_create = oc_gles_surface_create;
extern fn oc_gles_surface_create() callconv(.C) surface;
/// Make the GL context of the surface current.
pub const gles_surface_make_current = oc_gles_surface_make_current;
extern fn oc_gles_surface_make_current(
    surface: surface,
) callconv(.C) void;
/// Swap the buffers of a GLES surface.
pub const gles_surface_swap_buffers = oc_gles_surface_swap_buffers;
...
pub const input_process_event = oc_input_process_event;
extern fn oc_input_process_event(
    arena: [*c]arena,
    state: [*c]input_state,
    event: [*c]event,
) callconv(.C) void;
pub const input_next_frame = oc_input_next_frame;
extern fn oc_input_next_frame(
    state: [*c]input_state,
) callconv(.C) void;
pub const key_down = oc_key_down;
extern fn oc_key_down(
    state: [*c]input_state,
    key: key_code,
) callconv(.C) bool;
pub const key_press_count = oc_key_press_count;
extern fn oc_key_press_count(
    state: [*c]input_state,
    key: key_code,
) callconv(.C) u8;
pub const key_release_count = oc_key_release_count;
extern fn oc_key_release_count(
    state: [*c]input_state,
    key: key_code,
) callconv(.C) u8;
pub const key_repeat_count = oc_key_repeat_count;
extern fn oc_key_repeat_count(
    state: [*c]input_state,
    key: key_code,
) callconv(.C) u8;
pub const key_down_scancode = oc_key_down_scancode;
extern fn oc_key_down_scancode(
    state: [*c]input_state,
    key: scan_code,
) callconv(.C) bool;
pub const key_press_count_scancode = oc_key_press_count_scancode;
extern fn oc_key_press_count_scancode(
    state: [*c]input_state,
    key: scan_code,
) callconv(.C) u8;
pub const key_release_count_scancode = oc_key_release_count_scancode;
extern fn oc_key_release_count_scancode(
    state: [*c]input_state,
    key: scan_code,
) callconv(.C) u8;
pub const key_repeat_count_scancode = oc_key_repeat_count_scancode;
extern fn oc_key_repeat_count_scancode(
    state: [*c]input_state,
    key: scan_code,
) callconv(.C) u8;
pub const mouse_down = oc_mouse_down;
extern fn oc_mouse_down(
    state: [*c]input_state,
    button: mouse_button,
) callconv(.C) bool;
pub const mouse_pressed = oc_mouse_pressed;
extern fn oc_mouse_pressed(
    state: [*c]input_state,
    button: mouse_button,
) callconv(.C) u8;
pub const mouse_released = oc_mouse_released;
extern fn oc_mouse_released(
    state: [*c]input_state,
    button: mouse_button,
) callconv(.C) u8;
pub const mouse_clicked = oc_mouse_clicked;
extern fn oc_mouse_clicked(
    state: [*c]input_state,
    button: mouse_button,
) callconv(.C) bool;
pub const mouse_double_clicked = oc_mouse_double_clicked;
extern fn oc_mouse_double_clicked(
    state: [*c]input_state,
    button: mouse_button,
) callconv(.C) bool;
pub const mouse_position = oc_mouse_position;
extern fn oc_mouse_position(
    state: [*c]input_state,
) callconv(.C) vec2;
pub const mouse_delta = oc_mouse_delta;
extern fn oc_mouse_delta(
    state: [*c]input_state,
) callconv(.C) vec2;
pub const mouse_wheel = oc_mouse_wheel;
extern fn oc_mouse_wheel(
    state: [*c]input_state,
) callconv(.C) vec2;
pub const input_text_utf32 = oc_input_text_utf32;
extern fn oc_input_text_utf32(
    arena: [*c]arena,
    state: [*c]input_state,
) callconv(.C) str32;
pub const input_text_utf8 = oc_input_text_utf8;
extern fn oc_input_text_utf8(
    arena: [*c]arena,
    state: [*c]input_state,
) callconv(.C) str8;
pub const clipboard_pasted = oc_clipboard_pasted;
extern fn oc_clipboard_pasted(
    state: [*c]input_state,
) callconv(.C) bool;
pub const clipboard_pasted_text = oc_clipboard_pasted_text;
extern fn oc_clipboard_pasted_text(
    state: [*c]input_state,
) callconv(.C) str8;
pub const key_mods = oc_key_mods;
...
pub const ui_context_create = oc_ui_context_create;
extern fn oc_ui_context_create(
    defaultFont: font,
) callconv(.C) ?*ui_context;
pub const ui_context_destroy = oc_ui_context_destroy;
extern fn oc_ui_context_destroy(
    context: ?*ui_context,
) callconv(.C) void;
pub const ui_get_context = oc_ui_get_context;
extern fn oc_ui_get_context() callconv(.C) ?*ui_context;
pub const ui_set_context = oc_ui_set_context;
extern fn oc_ui_set_context(
    context: ?*ui_context,
) callconv(.C) void;
pub const ui_process_event = oc_ui_process_event;
extern fn oc_ui_process_event(
    event: [*c]event,
) callconv(.C) void;
pub const ui_frame_begin = oc_ui_frame_begin;
extern fn oc_ui_frame_begin(
    size: vec2,
) callconv(.C) void;
pub const ui_frame_end = oc_ui_frame_end;
extern fn oc_ui_frame_end() callconv(.C) void;
pub const ui_draw = oc_ui_draw;
extern fn oc_ui_draw() callconv(.C) void;
pub const ui_input = oc_ui_input;
extern fn oc_ui_input() callconv(.C) [*c]input_state;
pub const ui_frame_arena = oc_ui_frame_arena;
extern fn oc_ui_frame_arena() callconv(.C) [*c]arena;
pub const ui_frame_time = oc_ui_frame_time;
extern fn oc_ui_frame_time() callconv(.C) f64;
pub const ui_box_begin_str8 = oc_ui_box_begin_str8;
extern fn oc_ui_box_begin_str8(
    string: str8,
) callconv(.C) [*c]ui_box;
pub const ui_box_end = oc_ui_box_end;
extern fn oc_ui_box_end() callconv(.C) [*c]ui_box;
pub const ui_box_set_draw_proc = oc_ui_box_set_draw_proc;
extern fn oc_ui_box_set_draw_proc(
    box: [*c]ui_box,
    proc: ui_box_draw_proc,
    data: ?*anyopaque,
) callconv(.C) void;
pub const ui_box_set_text = oc_ui_box_set_text;
extern fn oc_ui_box_set_text(
    box: [*c]ui_box,
    text: str8,
) callconv(.C) void;
pub const ui_box_set_overlay = oc_ui_box_set_overlay;
extern fn oc_ui_box_set_overlay(
    box: [*c]ui_box,
    overlay: bool,
) callconv(.C) void;
pub const ui_box_set_closed = oc_ui_box_set_closed;
extern fn oc_ui_box_set_closed(
    box: [*c]ui_box,
    closed: bool,
) callconv(.C) void;
pub const ui_box_user_data_get = oc_ui_box_user_data_get;
extern fn oc_ui_box_user_data_get(
    box: [*c]ui_box,
) callconv(.C) [*c]u8;
pub const ui_box_user_data_push = oc_ui_box_user_data_push;
extern fn oc_ui_box_user_data_push(
    box: [*c]ui_box,
    size: u64,
) callconv(.C) [*c]u8;
pub const ui_box_request_focus = oc_ui_box_request_focus;
extern fn oc_ui_box_request_focus(
    box: [*c]ui_box,
) callconv(.C) void;
pub const ui_box_release_focus = oc_ui_box_release_focus;
extern fn oc_ui_box_release_focus(
    box: [*c]ui_box,
) callconv(.C) void;
pub const ui_box_get_sig = oc_ui_box_get_sig;
extern fn oc_ui_box_get_sig(
    box: [*c]ui_box,
) callconv(.C) ui_sig;
pub const ui_set_draw_proc = oc_ui_set_draw_proc;
extern fn oc_ui_set_draw_proc(
    proc: ui_box_draw_proc,
    data: ?*anyopaque,
) callconv(.C) void;
pub const ui_set_text = oc_ui_set_text;
extern fn oc_ui_set_text(
    text: str8,
) callconv(.C) void;
pub const ui_set_overlay = oc_ui_set_overlay;
extern fn oc_ui_set_overlay(
    overlay: bool,
) callconv(.C) void;
pub const ui_set_closed = oc_ui_set_closed;
extern fn oc_ui_set_closed(
    closed: bool,
) callconv(.C) void;
pub const ui_user_data_get = oc_ui_user_data_get;
extern fn oc_ui_user_data_get() callconv(.C) [*c]u8;
pub const ui_user_data_push = oc_ui_user_data_push;
extern fn oc_ui_user_data_push(
    size: u64,
) callconv(.C) [*c]u8;
pub const ui_request_focus = oc_ui_request_focus;
extern fn oc_ui_request_focus() callconv(.C) void;
pub const ui_release_focus = oc_ui_release_focus;
extern fn oc_ui_release_focus() callconv(.C) void;
pub const ui_get_sig = oc_ui_get_sig;
extern fn oc_ui_get_sig() callconv(.C) ui_sig;
pub const ui_box_tag_str8 = oc_ui_box_tag_str8;
extern fn oc_ui_box_tag_str8(
    box: [*c]ui_box,
    string: str8,
) callconv(.C) void;
pub const ui_tag_str8 = oc_ui_tag_str8;
extern fn oc_ui_tag_str8(
    string: str8,
) callconv(.C) void;
pub const ui_tag_next_str8 = oc_ui_tag_next_str8;
extern fn oc_ui_tag_next_str8(
    string: str8,
) callconv(.C) void;
pub const ui_style_rule_begin = oc_ui_style_rule_begin;
extern fn oc_ui_style_rule_begin(
    pattern: str8,
) callconv(.C) void;
pub const ui_style_rule_end = oc_ui_style_rule_end;
extern fn oc_ui_style_rule_end() callconv(.C) void;
pub const ui_style_set_i32 = oc_ui_style_set_i32;
extern fn oc_ui_style_set_i32(
    attr: ui_attribute,
    i: i32,
) callconv(.C) void;
pub const ui_style_set_f32 = oc_ui_style_set_f32;
extern fn oc_ui_style_set_f32(
    attr: ui_attribute,
    f: f32,
) callconv(.C) void;
pub const ui_style_set_color = oc_ui_style_set_color;
extern fn oc_ui_style_set_color(
    attr: ui_attribute,
    color: color,
) callconv(.C) void;
pub const ui_style_set_font = oc_ui_style_set_font;
extern fn oc_ui_style_set_font(
    attr: ui_attribute,
    font: font,
) callconv(.C) void;
pub const ui_style_set_size = oc_ui_style_set_size;
extern fn oc_ui_style_set_size(
    attr: ui_attribute,
    size: ui_size,
) callconv(.C) void;
pub const ui_style_set_var_str8 = oc_ui_style_set_var_str8;
extern fn oc_ui_style_set_var_str8(
    attr: ui_attribute,
    @"var": str8,
) callconv(.C) void;
pub const ui_style_set_var = oc_ui_style_set_var;
extern fn oc_ui_style_set_var(
    attr: ui_attribute,
    @"var": [*c]u8,
) callconv(.C) void;
pub const ui_var_default_i32_str8 = oc_ui_var_default_i32_str8;
extern fn oc_ui_var_default_i32_str8(
    name: str8,
    i: i32,
) callconv(.C) void;
pub const ui_var_default_f32_str8 = oc_ui_var_default_f32_str8;
extern fn oc_ui_var_default_f32_str8(
    name: str8,
    f: f32,
) callconv(.C) void;
pub const ui_var_default_size_str8 = oc_ui_var_default_size_str8;
extern fn oc_ui_var_default_size_str8(
    name: str8,
    size: ui_size,
) callconv(.C) void;
pub const ui_var_default_color_str8 = oc_ui_var_default_color_str8;
extern fn oc_ui_var_default_color_str8(
    name: str8,
    color: color,
) callconv(.C) void;
pub const ui_var_default_font_str8 = oc_ui_var_default_font_str8;
extern fn oc_ui_var_default_font_str8(
    name: str8,
    font: font,
) callconv(.C) void;
pub const ui_var_default_str8 = oc_ui_var_default_str8;
extern fn oc_ui_var_default_str8(
    name: str8,
    src: str8,
) callconv(.C) void;
pub const ui_var_default_i32 = oc_ui_var_default_i32;
extern fn oc_ui_var_default_i32(
    name: [*c]u8,
    i: i32,
) callconv(.C) void;
pub const ui_var_default_f32 = oc_ui_var_default_f32;
extern fn oc_ui_var_default_f32(
    name: [*c]u8,
    f: f32,
) callconv(.C) void;
pub const ui_var_default_size = oc_ui_var_default_size;
extern fn oc_ui_var_default_size(
    name: [*c]u8,
    size: ui_size,
) callconv(.C) void;
pub const ui_var_default_color = oc_ui_var_default_color;
extern fn oc_ui_var_default_color(
    name: [*c]u8,
    color: color,
) callconv(.C) void;
pub const ui_var_default_font = oc_ui_var_default_font;
extern fn oc_ui_var_default_font(
    name: [*c]u8,
    font: font,
) callconv(.C) void;
pub const ui_var_default = oc_ui_var_default;
extern fn oc_ui_var_default(
    name: [*c]u8,
    src: [*c]u8,
) callconv(.C) void;
pub const ui_var_set_i32_str8 = oc_ui_var_set_i32_str8;
extern fn oc_ui_var_set_i32_str8(
    name: str8,
    i: i32,
) callconv(.C) void;
pub const ui_var_set_f32_str8 = oc_ui_var_set_f32_str8;
extern fn oc_ui_var_set_f32_str8(
    name: str8,
    f: f32,
) callconv(.C) void;
pub const ui_var_set_size_str8 = oc_ui_var_set_size_str8;
extern fn oc_ui_var_set_size_str8(
    name: str8,
    size: ui_size,
) callconv(.C) void;
pub const ui_var_set_color_str8 = oc_ui_var_set_color_str8;
extern fn oc_ui_var_set_color_str8(
    name: str8,
    color: color,
) callconv(.C) void;
pub const ui_var_set_font_str8 = oc_ui_var_set_font_str8;
extern fn oc_ui_var_set_font_str8(
    name: str8,
    font: font,
) callconv(.C) void;
pub const ui_var_set_str8 = oc_ui_var_set_str8;
extern fn oc_ui_var_set_str8(
    name: str8,
    src: str8,
) callconv(.C) void;
pub const ui_var_set_i32 = oc_ui_var_set_i32;
extern fn oc_ui_var_set_i32(
    name: [*c]u8,
    i: i32,
) callconv(.C) void;
pub const ui_var_set_f32 = oc_ui_var_set_f32;
extern fn oc_ui_var_set_f32(
    name: [*c]u8,
    f: f32,
) callconv(.C) void;
pub const ui_var_set_size = oc_ui_var_set_size;
extern fn oc_ui_var_set_size(
    name: [*c]u8,
    size: ui_size,
) callconv(.C) void;
pub const ui_var_set_color = oc_ui_var_set_color;
extern fn oc_ui_var_set_color(
    name: [*c]u8,
    color: color,
) callconv(.C) void;
pub const ui_var_set_font = oc_ui_var_set_font;
extern fn oc_ui_var_set_font(
    name: [*c]u8,
    font: font,
) callconv(.C) void;
pub const ui_var_set = oc_ui_var_set;
extern fn oc_ui_var_set(
    name: [*c]u8,
    src: [*c]u8,
) callconv(.C) void;
pub const ui_var_get_i32_str8 = oc_ui_var_get_i32_str8;
extern fn oc_ui_var_get_i32_str8(
    name: str8,
) callconv(.C) i32;
pub const ui_var_get_f32_str8 = oc_ui_var_get_f32_str8;
extern fn oc_ui_var_get_f32_str8(
    name: str8,
) callconv(.C) f32;
pub const ui_var_get_size_str8 = oc_ui_var_get_size_str8;
extern fn oc_ui_var_get_size_str8(
    name: str8,
) callconv(.C) ui_size;
pub const ui_var_get_color_str8 = oc_ui_var_get_color_str8;
extern fn oc_ui_var_get_color_str8(
    name: str8,
) callconv(.C) color;
pub const ui_var_get_font_str8 = oc_ui_var_get_font_str8;
extern fn oc_ui_var_get_font_str8(
    name: str8,
) callconv(.C) font;
pub const ui_var_get_i32 = oc_ui_var_get_i32;
extern fn oc_ui_var_get_i32(
    name: [*c]u8,
) callconv(.C) i32;
pub const ui_var_get_f32 = oc_ui_var_get_f32;
extern fn oc_ui_var_get_f32(
    name: [*c]u8,
) callconv(.C) f32;
pub const ui_var_get_size = oc_ui_var_get_size;
extern fn oc_ui_var_get_size(
    name: [*c]u8,
) callconv(.C) ui_size;
pub const ui_var_get_color = oc_ui_var_get_color;
extern fn oc_ui_var_get_color(
    name: [*c]u8,
) callconv(.C) color;
pub const ui_var_get_font = oc_ui_var_get_font;
extern fn oc_ui_var_get_font(
    name: [*c]u8,
) callconv(.C) font;
pub const ui_theme_dark = oc_ui_theme_dark;
extern fn oc_ui_theme_dark() callconv(.C) void;
pub const ui_theme_light = oc_ui_theme_light;
...
pub const ui_label = oc_ui_label;
extern fn oc_ui_label(
    key: [*c]u8,
    label: [*c]u8,
) callconv(.C) ui_sig;
pub const ui_label_str8 = oc_ui_label_str8;
extern fn oc_ui_label_str8(
    key: str8,
    label: str8,
) callconv(.C) ui_sig;
pub const ui_button = oc_ui_button;
extern fn oc_ui_button(
    key: [*c]u8,
    text: [*c]u8,
) callconv(.C) ui_sig;
pub const ui_button_str8 = oc_ui_button_str8;
extern fn oc_ui_button_str8(
    key: str8,
    text: str8,
) callconv(.C) ui_sig;
pub const ui_checkbox = oc_ui_checkbox;
extern fn oc_ui_checkbox(
    key: [*c]u8,
    checked: [*c]bool,
) callconv(.C) ui_sig;
pub const ui_checkbox_str8 = oc_ui_checkbox_str8;
extern fn oc_ui_checkbox_str8(
    key: str8,
    checked: [*c]bool,
) callconv(.C) ui_sig;
pub const ui_slider = oc_ui_slider;
extern fn oc_ui_slider(
    name: [*c]u8,
    value: [*c]f32,
) callconv(.C) [*c]ui_box;
pub const ui_slider_str8 = oc_ui_slider_str8;
extern fn oc_ui_slider_str8(
    name: str8,
    value: [*c]f32,
) callconv(.C) [*c]ui_box;
pub const ui_tooltip = oc_ui_tooltip;
extern fn oc_ui_tooltip(
    key: [*c]u8,
    text: [*c]u8,
) callconv(.C) void;
pub const ui_tooltip_str8 = oc_ui_tooltip_str8;
extern fn oc_ui_tooltip_str8(
    key: str8,
    text: str8,
) callconv(.C) void;
pub const ui_menu_bar_begin = oc_ui_menu_bar_begin;
extern fn oc_ui_menu_bar_begin(
    key: [*c]u8,
) callconv(.C) void;
pub const ui_menu_bar_begin_str8 = oc_ui_menu_bar_begin_str8;
extern fn oc_ui_menu_bar_begin_str8(
    key: str8,
) callconv(.C) void;
pub const ui_menu_bar_end = oc_ui_menu_bar_end;
extern fn oc_ui_menu_bar_end() callconv(.C) void;
pub const ui_menu_begin = oc_ui_menu_begin;
extern fn oc_ui_menu_begin(
    key: [*c]u8,
    name: [*c]u8,
) callconv(.C) void;
pub const ui_menu_begin_str8 = oc_ui_menu_begin_str8;
extern fn oc_ui_menu_begin_str8(
    key: str8,
    name: str8,
) callconv(.C) void;
pub const ui_menu_end = oc_ui_menu_end;
extern fn oc_ui_menu_end() callconv(.C) void;
pub const ui_menu_button = oc_ui_menu_button;
extern fn oc_ui_menu_button(
    key: [*c]u8,
    text: [*c]u8,
) callconv(.C) ui_sig;
pub const ui_menu_button_str8 = oc_ui_menu_button_str8;
...
pub const ui_text_box = oc_ui_text_box;
extern fn oc_ui_text_box(
    key: [*c]u8,
    arena: [*c]arena,
    info: [*c]ui_text_box_info,
) callconv(.C) ui_text_box_result;
pub const ui_text_box_str8 = oc_ui_text_box_str8;
...
pub const ui_select_popup = oc_ui_select_popup;
extern fn oc_ui_select_popup(
    key: [*c]u8,
    info: [*c]ui_select_popup_info,
) callconv(.C) ui_select_popup_info;
pub const ui_select_popup_str8 = oc_ui_select_popup_str8;
...
pub const ui_radio_group = oc_ui_radio_group;
extern fn oc_ui_radio_group(
    key: [*c]u8,
    info: [*c]ui_radio_group_info,
) callconv(.C) ui_radio_group_info;
pub const ui_radio_group_str8 = oc_ui_radio_group_str8;
